...
find ./ReactApp/* \( -type d -name 'node_modules' -prune \) -o \( -type d -name 'dist' -prune \) -o \( -type f -name '*.ico' -prune \) -o \( -type f -name '*.md' -prune \) -o \( -type f -name '*.png' -prune \) -o \( -type f -name '*.gitignore' -prune \) -o \( -type f -name '*.css' -prune \) -o \( -type f -name '*.ico' -prune \) -o \( -type f -name 'package-lock.json' -prune \) -o -type f -print0 | while IFS= read -r -d $'\0' file; do
